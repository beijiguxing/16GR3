	...
	private String object ="from UserBean";
		...
		public String getAll(){
			try {
				...
				UserBean us1=(UserBean) list.get(0);
				System.out.println(us1.getSex()+"/"+us1.getEnable());
				UserBean us2=(UserBean) list.get(1);
				System.out.println(us2.getSex()+"/"+us2.getEnable());
			} catch (Exception e) {
				e.printStackTrace();
			}
			return "list";
