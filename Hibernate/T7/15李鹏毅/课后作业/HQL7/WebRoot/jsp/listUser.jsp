...
<html>
  ...
  <td>部门</td><td>账号昵称</td><td>密码</td><td>操作1</td><td>操作2</td>
  ...
  <tr>
  	...
  	<td><s:property value="#emp.dept" /></td>
  	<td><s:property value="#emp.user.uname" /></td>
  	<td><s:property value="#emp.user.upwd" /></td>
