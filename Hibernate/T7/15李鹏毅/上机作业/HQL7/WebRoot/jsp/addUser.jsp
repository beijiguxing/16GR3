...
<html>
  ...
  <body>
       <s:form action="user!add" method="post" namespace="/">
   		...
   		<s:textfield label="部门" required="true" name="emp.dept"> </s:textfield>
   		<s:textfield label="账号昵称" required="true" name="user.uname"> </s:textfield>
  		<s:password label="密码" required="true" name="user.upwd"></s:password>
